		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "노형석",
									"targetURL": "#Testprojectb0903-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Testprojectb0903-display": {
								"semanticObject": "Testprojectb0903",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Test.projectb0903",
									"url": sap.ui.require.toUrl("Test/projectb0903")
								}
							}
						}
					}
