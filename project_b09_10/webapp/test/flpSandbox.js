		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My App",
									"targetURL": "#projectb0910-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0910-display": {
								"semanticObject": "projectb0910",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0910",
									"url": sap.ui.require.toUrl("projectb0910")
								}
							}
						}
					}
