		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회 (B09)",
									"targetURL": "#examexprogramb09-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb09-display": {
								"semanticObject": "examexprogramb09",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb09",
									"url": sap.ui.require.toUrl("exam/exprogramb09")
								}
							}
						}
					}
