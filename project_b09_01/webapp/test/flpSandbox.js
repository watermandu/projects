		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "project_b09_01",
									"targetURL": "#syncprojectb0901-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncprojectb0901-display": {
								"semanticObject": "syncprojectb0901",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.projectb0901",
									"url": sap.ui.require.toUrl("sync/projectb0901")
								}
							}
						}
					}
