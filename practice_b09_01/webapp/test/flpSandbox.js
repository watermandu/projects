		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#practiceb0901-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"practiceb0901-display": {
								"semanticObject": "practiceb0901",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=practiceb0901",
									"url": sap.ui.require.toUrl("practiceb0901")
								}
							}
						}
					}
