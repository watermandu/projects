		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#odatacrudb09-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatacrudb09-display": {
								"semanticObject": "odatacrudb09",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatacrudb09",
									"url": sap.ui.require.toUrl("odatacrudb09")
								}
							}
						}
					}
