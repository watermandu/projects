					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[TAEDONG-SD] 고객정보 조회",
									"targetURL": "#zbcsd110-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zbcsd110-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbcsd110",
									"url": sap.ui.require.toUrl("zbcsd110")
								}
							}
						}
					}
