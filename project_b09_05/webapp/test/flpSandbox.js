		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Title",
									"targetURL": "#syncprojectb0905-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncprojectb0905-display": {
								"semanticObject": "syncprojectb0905",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.projectb0905",
									"url": sap.ui.require.toUrl("sync/projectb0905")
								}
							}
						}
					}
