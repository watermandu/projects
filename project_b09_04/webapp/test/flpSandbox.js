		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON CRUD",
									"targetURL": "#syncprojectb0904-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncprojectb0904-display": {
								"semanticObject": "syncprojectb0904",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.projectb0904",
									"url": sap.ui.require.toUrl("sync/projectb0904")
								}
							}
						}
					}
