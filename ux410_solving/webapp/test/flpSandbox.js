		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpux410solving-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solving-display": {
								"semanticObject": "sapbtpux410solving",
								"action": "display",
								"description": "US410 문제",
								"title": "UX410 문제",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solving",
									"url": sap.ui.require.toUrl("sap/btp/ux410solving")
								}
							}
						}
					}
